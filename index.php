...
if(isset($_POST['name'])){
  ...
  if(!$con){
    die("connection to this database failed due to". mysqil_connect_error());
  }
...
<body>
    ...
    <div class="container">
      ...
      ?>
       ...
       <textarea name="desc" id="desc" cols="30" row="10" placeholder="Enter any other information here"></textarea>
